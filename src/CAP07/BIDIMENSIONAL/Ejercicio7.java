...
public class Ejercicio7 {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (y == 0 & x == 0) {
                if (y + 1 == mina[1] | x + 1 == mina[0] | x + 2 == mina[0])
                    System.out.println("¡Cuidado! ¡Hay una mina cerca!");
            } else if (y == 3 & x == 0) {
                if (y - 1 == mina[1] | x + 1 == mina[0])
                    System.out.println("¡Cuidado! ¡Hay una mina cerca!");
            } else if (y == 0 & x == 4) {
                if (y + 1 == mina[1] | x - 1 == mina[0])
                    System.out.println("¡Cuidado! ¡Hay una mina cerca!");
                ...
                if (y - 1 == mina[1] | y + 1 == mina[0] | x + 1 == mina[0])
                    System.out.println("¡Cuidado! ¡Hay una mina cerca!");
            } else if (x == 4) {
                if (y - 1 == mina[1] | y + 1 == mina[0] | x - 1 == mina[0])
                    System.out.println("¡Cuidado! ¡Hay una mina cerca!");
            } else if (y == 0) {
                if (y + 1 == mina[1] | y - 1 == mina[1] | x - 1 == mina[0] | x + 1 == mina[0])
                    System.out.println("¡Cuidado! ¡Hay una mina cerca!");
            } else {
                if (y - 1 == mina[1] | x + 1 == mina[0] | x - 1 == mina[0]) {
                    System.out.println("¡Cuidado! ¡Hay una mina cerca!");
                }
            }
        } while (!salir);
